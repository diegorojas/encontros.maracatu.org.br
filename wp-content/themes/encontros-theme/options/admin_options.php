...
array( "name" => "Dados do Evento", //* Dados do Evento */
	"type" => "section"),
array( "type" => "open"),
	
array( "name" => "Data do Evento", 
	"desc" => "Adicione a data do evento por extenso.",
	"id" => $shortname."_header_date",
	"type" => "text",
	"std" => ""),

array( "name" => "Cidade do Evento", 
	"desc" => "Adicione a Cidade e o Estado",
	"id" => $shortname."_header_place",
	"type" => "text",
	"std" => ""),
...
array( "name" => "Créditos no Rodap&eacute;",
	"desc" => "Adicione a descriç&atilde;o dos créditos do projeto.",
