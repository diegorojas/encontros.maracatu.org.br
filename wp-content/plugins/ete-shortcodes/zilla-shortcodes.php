...
class ZillaShortcodes {
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => WP_PLUGIN_URL .'/ete-shortcodes') );
	}
